...
function AppPreviewD({nameSpace, URLSpace, color, logo}){
  useEffect(()=>{
    console.info('HERE')
  }, []);
  return (
    <>
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 807 598">
            <defs>
                <clipPath id="a">
                    <rect className="a" width="807" height="598" transform="translate(1093 225)"/></clipPath>
                    <filter id="b" x="135" y="34" width="830" height="602" filterUnits="userSpaceOnUse">
                    ...
                    <clipPath id="d">
                        <rect className="b" width="680" height="452" transform="translate(3689 642)"/>
                    </clipPath>
                    <filter id="e" x="276" y="273" width="573" height="46" filterUnits="userSpaceOnUse">
                    ...
                    <filter id="g" x="276" y="320" width="573" height="46" filterUnits="userSpaceOnUse">
                        <feOffset dy="1" input="SourceAlpha"/>
                    ...
                    <filter id="i" x="276" y="367" width="573" height="46" filterUnits="userSpaceOnUse">
                        <feOffset dy="1" input="SourceAlpha"/>
                    ...
                    <filter id="k" x="276" y="414" width="573" height="46" filterUnits="userSpaceOnUse">
                        <feOffset dy="1" input="SourceAlpha"/>
                    ...
                    <filter id="m" x="276" y="461" width="573" height="46" filterUnits="userSpaceOnUse">
                        <feOffset dy="1" input="SourceAlpha"/>
                    ...
                    <clipPath id="o">
                        <path className="c" d="M5,0H680a0,0,0,0,1,0,0V447a5,5,0,0,1-5,5H0a0,0,0,0,1,0,0V5A5,5,0,0,1,5,0Z" transform="translate(3689 642)"/>
                    </clipPath>
                </defs>
                <g className="d" transform="translate(-1093 -225)">
                    <g transform="translate(1321.7 224.819)">
                        <g transform="translate(14.087)">
                            <ellipse className="e" cx="37.944" cy="37.944" rx="37.944" ry="37.944" transform="translate(211.027 21.048)"/>
                            <rect className="f" width="70.618" height="187.611" transform="translate(299.162 0.351) rotate(30)"/>
                            <path className="g" d="M344.817,589.12c-5.217,3.069-11.438,7.973-18.217,15.848" transform="translate(-170.071 -428.453)"/>
                        </g>
                    ...
                    <g transform="translate(1175.7 502.819)">
                        <g transform="translate(14.087)">
                            <rect className="i" width="102.37" height="97.16" transform="translate(48.775 70.727)"/>
                            <path className="j" d="M569.246,70.93,517.6,119.941,615.622,175.8Z" transform="translate(-517.6 -70.93)"/>
                        </g>
                    ...
                    <g transform="translate(-2386 -340)">
                        <g className="al" transform="matrix(1, 0, 0, 1, 3479, 565)">
                            <path className="k" d="M5,0H680a0,0,0,0,1,0,0V447a5,5,0,0,1-5,5H5a5,5,0,0,1-5-5V5A5,5,0,0,1,5,0Z" transform="translate(210 77)"/>
                        </g>
                        <g className="l">
                            <g className="b" transform="translate(3689 717)">
                                <rect className="af" width="688" height="377"/>
                                <rect className="ac" x="0.5" y="0.5" width="687" height="376"/>
                            </g>
                            <g className="m" transform="translate(3767 688)">
                                <rect className="af" width="626" height="24" rx="12"/>
                                <rect className="ac" x="0.5" y="0.5" width="625" height="23" rx="11.5"/>
                            </g>
                        </g>
                        <g transform="translate(-28 -11)">
                            <rect className="n" width="8" height="46" transform="translate(3781 849)"/>
                            <rect className="n" width="8" height="46" transform="translate(3781 896)"/>
                            <rect className="n" width="8" height="46" transform="translate(3781 990)"/>
                            <rect className="n" width="8" height="46" transform="translate(3781 1037)"/>
                            <g className="ak" transform="matrix(1, 0, 0, 1, 3507, 576)">
                                <rect className="c" width="573" height="45" transform="translate(276 273)"/>
                            </g>
                            ...
                            <g className="ag" transform="matrix(1, 0, 0, 1, 3507, 576)">
                                <rect className="c" width="573" height="45" transform="translate(276 461)"/>
                            </g>
                            ...
                            <rect className="r" width="107" height="9" rx="4.5" transform="translate(3797 867)"/>
                            <rect className="r" width="107" height="9" rx="4.5" transform="translate(3910 867)"/>
                        ...
                        <path className="k" d="M3716.049,651h192.556c3.97,0,7.189,2.239,7.189,5v21s-.331,7,8.659,7H3701.231c6.676,0,7.629-7,7.629-7V656C3708.861,653.238,3712.079,651,3716.049,651Z"/>
                        ...
                        <g transform="translate(3719.776 661.963)">
                            <rect className="k" width="10.252" height="2.239" rx="1.12" transform="translate(0 6.718)"/>
                            <rect className="k" width="7.831" height="2.239" rx="1.12" transform="translate(2.421)"/>
                            <rect className="k" width="6.155" height="2.239" rx="1.12" transform="translate(6.337 3.359)"/>
                            <rect className="k" width="4.479" height="2.239" rx="1.12" transform="translate(0.182 3.359)"/>
                            <rect className="k" width="4.479" height="2.239" rx="1.12" transform="translate(0.182 10.097)"/>
                        </g>
                        <g className="y">
                            <g transform="translate(3689 716)">
                                <g className="b">
                                    <rect className="af" width="49" height="378"/>
                                    <rect className="ac" x="0.5" y="0.5" width="48" height="377"/>
                                </g>
                                <rect className="z" width="34" height="37" rx="3" transform="translate(7 90)"/>
                                <g transform="translate(14 14.941)">
                                    <rect className="aa" width="21.244" height="4.641" rx="2.32" transform="translate(0 13.922)"/>
                                    <rect className="aa" width="16.227" height="4.641" rx="2.32" transform="translate(5.009)"/>
                                    <rect className="aa" width="12.754" height="4.641" rx="2.32" transform="translate(13.122 6.961)"/>
                                    <rect className="aa" width="9.281" height="4.641" rx="2.32" transform="translate(0 6.961)"/>
                                    <rect className="aa" width="9.281" height="4.641" rx="2.32" transform="translate(0 20.922)"/>
                                </g>
                            ...
                            <g transform="translate(3737 716)">
                                ...
                                <rect className="r" width="211" height="21" rx="10.5" transform="translate(16 18)"/>
                            </g>
                        </g>
                        <g transform="translate(3740 693)">
                            <path className="ac" d="M0,0H14.931V14.931H0Z"/>
                            <path d="M12.5,5.462a4.978,4.978,0,1,0,1.294,4.759H12.5A3.731,3.731,0,1,1,8.981,5.244a3.68,3.68,0,0,1,2.625,1.107l-2,2h4.355V4Z" transform="translate(-1.515 -1.511)"/>
                        </g>
                        <g className="ad" transform="translate(3718 693)">
                            <path className="ac" d="M0,0H15V15H0Z"/>
                            <path d="M9,4l-.881.881,3.488,3.494H4v1.25h7.606L8.119,13.119,9,14l5-5Z" transform="translate(-1.5 -1.5)"/>
                        </g>
                        <g transform="translate(3697 693)">
                            <path className="ac" d="M15,0H0V15H15Z"/>
                            <path d="M9,4l.881.881L6.394,8.375H14v1.25H6.394l3.488,3.494L9,14,4,9Z" transform="translate(-1.5 -1.5)"/>
                        </g>
                        <g transform="translate(3891.797 660.796)">
                            <path className="ac" d="M0,0H14.407V14.407H0Z"/>
                            <path d="M13.4,5.846,12.558,5,9.2,8.356,5.846,5,5,5.846,8.356,9.2,5,12.558l.846.846L9.2,10.049,12.558,13.4l.846-.846L10.049,9.2Z" transform="translate(-1.998 -1.998)"/>
                        </g>
                        <g transform="translate(3924.893 658.524)">
                            <path className="ac" d="M0,0H17.583V17.583H0Z"/>
                            <path d="M15.257,10.861h-4.4v4.4H9.4v-4.4H5V9.4H9.4V5h1.465V9.4h4.4Z" transform="translate(-1.337 -1.337)"/>
                        </g>
                        <g transform="translate(3776 693.857)">
                            <path className="ac" d="M0,0H12.794V12.794H0Z"/>
                            <path className="ae" d="M11.463,4.732H10.93V3.665a2.665,2.665,0,1,0-5.331,0V4.732H5.066A1.069,1.069,0,0,0,4,5.8v5.331a1.069,1.069,0,0,0,1.066,1.066h6.4a1.069,1.069,0,0,0,1.066-1.066V5.8A1.069,1.069,0,0,0,11.463,4.732Zm-3.2,4.8A1.066,1.066,0,1,1,9.331,8.463,1.069,1.069,0,0,1,8.265,9.529Zm1.653-4.8H6.612V3.665a1.653,1.653,0,1,1,3.305,0Z" transform="translate(-1.868 -0.467)"/>
                        </g>
                    </g>
                </g>
            </svg>
